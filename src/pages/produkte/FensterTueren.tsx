...
import img1 from "@/assets/test/fenster-alt1.jpg";
import img2 from "@/assets/test/fenster-alt2.jpg";
import img3 from "@/assets/test/fenster-alt3.jpg";

const images = [
  { src: img1, label: "Einfamilienhaus" },
  { src: img2, label: "Fachwerkhaus" },
  { src: img3, label: "Modernes Kubushaus" },
];

const features = [
  "3-fach Wärmeschutzverglasung",
  "RC2 Einbruchschutz serienmäßig",

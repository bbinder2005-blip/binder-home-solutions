...
export const calendlyPhoneUrl = import.meta.env.VITE_CALENDLY_PHONE_URL || "https://calendly.com/fachberatung-binder-info/neues-meeting";
export const calendlyHomeUrl = import.meta.env.VITE_CALENDLY_HOME_URL || "https://calendly.com/fachberatung-binder-info/vor-ort-termin-vereinbaren-kostenlos-unverbindlich";
export const bookingSectionPath = "/kontakt#termin";
